...
#     if perceived not true
#      1 time perception call wo sind objekte
#       perceived 'true'
#     loop for perception call spawn objects in meiner welt
#     (Knowledge  was ist das naechste objekt was ich nehmen soll) optional
#     objekt aufheben )pick up
#     navigate to table
#     place object
'''
